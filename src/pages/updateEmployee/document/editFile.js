                        ...
                        <div className="form-container">
                            <Form.Item label="Document Type">
                                {getFieldDecorator('documentTypeId', {
                                    initialValue: this.state.documentTypeList.length != 0 ? this.props.data.documentTypeId : null,
...
const WrappedEditFileForm = Form.create({ name: 'addUser' })(EditFile);

export default WrappedEditFileForm;
